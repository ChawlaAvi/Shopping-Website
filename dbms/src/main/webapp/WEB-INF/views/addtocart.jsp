...
<div id='cssmenu'>
   ...
   <li class="active" style="float:right"><a href='/dbms/myproducts'>My Cart</a></li>  
	...
	<BR>
	<h2><center>ADD ITEM TO CART</center></h2>
	<br>
...
<center>
	...
	<form:form method="post" modelAttribute="lp" action="/dbms/allproducts/${lp.getProduct().product_id}/${lp.packet_size}/add">
				
		<form:hidden path="packet_size"></form:hidden>
		<form:hidden path="price"></form:hidden>
		<form:hidden path="available"></form:hidden>
		...
		<form:input path="quantity" type="number" placeholder="quantity you want to add" required="true" /><!-- bind to user.name-->
